...
/*
          ...
          floatingActionButton: itemCount == 0 || showCart == false
              ? SizedBox()
              : Container(
            height: 80,
            color: Colors.white,
                                ...
                                Row(
                                  ...
                                  children: [
                                    Container(
                                      width: mediaQueryWidth*0.3,
                                      height: 1,
                                      margin: EdgeInsets.only(left: selectIndex != 3  ? 7 : 0),
                                    ...
                                    Container(
                                      width: mediaQueryWidth*0.3,
                                      height: 1,
                                      margin: EdgeInsets.only(right: selectIndex != 5 ? 7 : 0),
                                ...
                                Row(
                                  ...
                                  children: [
                                    Container(
                                      width: mediaQueryWidth*0.3,
                                      height: 1,
                                      margin: EdgeInsets.only(left: selectIndex != 6  ? 7 : 0),
                                    ...
                                    Container(
                                      width: mediaQueryWidth*0.3,
                                      height: 1,
                                      margin: EdgeInsets.only(right: selectIndex != 8 ? 7 : 0),
  ...
  Future<void> dashboard() async {
    ...
    if (dataAPI["RETURN_FLAG"] == true) {
      ...
      setState(() {
        ...
        print("categories:" + catList.first.toString());
