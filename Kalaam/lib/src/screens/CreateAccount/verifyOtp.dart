  ...
  void initState() {
    ...
    setState(() {
      if (otpCreate == "") {
        ...
        // one.text = otpCreate.substring(0,1);
        // two.text = otpCreate.substring(1,2);
        // three.text = otpCreate.substring(2,3);
        // four.text = otpCreate.substring(3);
        colorChange = true;
      }
    });
  }
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children:[
                                        SizedBox(
                                          width: 40,
                                          child: //CustomWidgets.textOTPField("1", four, context),
                                          TextField(
                                            controller: four,
                                            textAlign: TextAlign.center,
                                            ...
                                            onChanged: (text){
                                              setState(() {
                                                colorChange=true;
                                                otpCreate = one.text+two.text+three.text+four.text;
...
*/
  ...
  void verifyOtp() async {
    ...
    var otpData = await verifyOTP(otpEnc);
